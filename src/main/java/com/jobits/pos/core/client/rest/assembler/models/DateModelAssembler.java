 ...
 * @author Home
 */
public class DateModelAssembler implements RepresentationModelAssembler<Date, EntityModel<Date>> {

    protected Class<? extends CrudRestServiceTemplate<Configuracion>> serviceClass = ConfiguracionEndPoint.class;

    public DateModelAssembler() {
    }

    @Override
    public EntityModel<Date> toModel(Date entity) {
