 ...
 * @author Home
 */
public class FloatModelAssembler implements RepresentationModelAssembler<Float, EntityModel<Float>> {

    protected Class<? extends CrudRestServiceTemplate<Venta>> serviceClass = VentaDetailEndPoint.class;

    public FloatModelAssembler() {
    }

    @Override
    public EntityModel<Float> toModel(Float entity) {
