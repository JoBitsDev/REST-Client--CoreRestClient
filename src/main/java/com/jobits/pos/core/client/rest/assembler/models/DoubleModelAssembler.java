 ...
 * @author Home
 */
public class DoubleModelAssembler implements RepresentationModelAssembler<Double, EntityModel<Double>> {

    protected Class<? extends CrudRestServiceTemplate<Venta>> serviceClass = VentaDetailEndPoint.class;

    public DoubleModelAssembler() {
    }

    @Override
    public EntityModel<Double> toModel(Double entity) {
