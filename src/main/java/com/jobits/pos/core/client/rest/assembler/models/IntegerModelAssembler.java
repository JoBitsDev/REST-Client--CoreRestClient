 ...
 * @author Home
 */
public class IntegerModelAssembler implements RepresentationModelAssembler<Integer, EntityModel<Integer>> {

    protected Class<? extends CrudRestServiceTemplate<Venta>> serviceClass = VentaDetailEndPoint.class;

    public IntegerModelAssembler() {
    }

    @Override
    public EntityModel<Integer> toModel(Integer entity) {
